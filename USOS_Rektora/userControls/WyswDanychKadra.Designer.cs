namespace USOS_Rektora.userControls
{
    partial class WyswDanychKadra
    {
        ...
        private void InitializeComponent()
        {
            ...
            tableDane.ColumnCount = 7;
            tableDane.ColumnStyles.Add(new ColumnStyle(SizeType.Absolute, 30F));
            tableDane.ColumnStyles.Add(new ColumnStyle(SizeType.Percent, 16.666111F));
            tableDane.ColumnStyles.Add(new ColumnStyle(SizeType.Percent, 16.666111F));
            tableDane.ColumnStyles.Add(new ColumnStyle(SizeType.Percent, 16.666111F));
            tableDane.ColumnStyles.Add(new ColumnStyle(SizeType.Percent, 16.666111F));
            tableDane.ColumnStyles.Add(new ColumnStyle(SizeType.Percent, 16.6661148F));
            tableDane.ColumnStyles.Add(new ColumnStyle(SizeType.Percent, 16.669445F));
            ...
            label6.Location = new Point(597, 1);
            label6.Margin = new Padding(0);
            label6.Name = "label6";
            label6.Size = new Size(114, 480);
            label6.TabIndex = 5;
            ...
            label5.Location = new Point(484, 1);
            label5.Margin = new Padding(0);
            label5.Name = "label5";
            label5.Size = new Size(112, 480);
            label5.TabIndex = 4;
            ...
            label4.Name = "label4";
            label4.Size = new Size(112, 480);
            label4.TabIndex = 3;
            label4.Text = "Adres Zamieszkania";
            ...
            label3.Location = new Point(258, 1);
            label3.Margin = new Padding(0);
            label3.Name = "label3";
            label3.Size = new Size(112, 480);
            label3.TabIndex = 2;
